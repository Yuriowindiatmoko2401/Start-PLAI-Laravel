...
(function($) {
    ...
    $('body').prepend('<a href="#" id="backToTopBtn" class="back-to-top page-scroll">Back to Top</a>');
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > amountScrolled) {
            ...
            $('#mini-modal').fadeOut(200); // Sembunyikan modal saat scroll ke atas
        }
    });

    // Tampilkan modal kecil saat tombol diklik
    $(document).on('click', '#backToTopBtn', function (e) {
        e.preventDefault();
        $('#mini-modal').fadeToggle(200); // toggle modal kecil
    });

    // Tutup modal saat klik tombol X
    $(document).on('click', '#close-mini-modal', function () {
        $('#mini-modal').fadeOut(200);
    });
