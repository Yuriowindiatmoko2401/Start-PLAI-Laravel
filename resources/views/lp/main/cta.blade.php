    <section class="relative z-10 overflow-hidden py-16 px-8 bg-zinc-950">
        <div class="container">
            <div class="-mx-4 flex flex-wrap items-center">
                <div class="w-6/5 px-14 lg:w-2/3">
                    <div class="text-center lg:text-left ">
                        <div class="mb-10 lg:mb-0 ">
                            <h1
                                class="mt-0 mb-1 text-xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-xl md:leading-tight text-[#E2C665] ">
                                Bergabunglah dengan PLAI BMD Sekarang!</h1>
                            <h1
                                class="mt-0 mb-3 text-xl font-semibold leading-tight sm:text-4xl sm:leading-tight md:text-xl md:leading-tight text-white ">
                                Terbuka untuk tahun ajaran 2025/2026</h1>
                            <p
                                class="w-full text-base font-medium leading-relaxed sm:text-lg sm:leading-relaxed text-white">
                                <a href="#" class="ml-[2px]">
                                    Informasi selengkapnya di<b class="text-[#E2C665]"> start.plai.ac.id</b>
                                </a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="w-full px-4 lg:w-1/3">
                    <div class="text-center">
                        <a class="btn-solid-lg !text-semibold" href="#your-link">Daftar PMB</a>
                    </div>
                </div>
            </div>
        </div>
