        <footer class="w-full py-10 radial-three-step-reason">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto">
                    <a href="/" class="flex justify-center ">
                        <img src="assets/images/logo/BMD-LOGO.png" class="h-24" alt="">
                    </a>
                    {{-- <ul
                        ...
                        <li><a href="#" class="text-white hover:text-[#E2C665]">Pagedone</a></li>
                        <li><a href="#" class=" text-white hover:text-[#E2C665]">Products</a></li>
                        <li><a href="#" class=" text-white hover:text-[#E2C665]">Resources</a></li>
                        <li><a href="#" class=" text-white hover:text-[#E2C665]">Blogs</a></li>
                        <li><a href="#" class=" text-white hover:text-[#E2C665]">Support</a></li>
                    </ul> --}}
                    <div class="flex space-x-10 justify-center items-center mb-14 pt-10 ">
                        <a href="#" class="block  text-white hover:text-[#E2C665] transition-all duration-500 ">
                        ...
                        <a href="#" class="block  text-white hover:text-[#E2C665] transition-all duration-500 ">
                            <svg class="w-[1.688rem] h-[1.688rem]" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="text-lg text-white text-center block">©<a href="https://pagedone.io/"
                            class="text-[#E2C665]">PLAI BMD</a>
