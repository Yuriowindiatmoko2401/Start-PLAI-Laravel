        ...
        <div class="container px-4 md:px-0 flex flex-wrap items-center justify-between lg:flex-nowrap">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="#tuition" class="text-gray-300 hover:text-[#E2C665] transition">Biaya Kuliah</a>
            ...
            <div class="hidden md:hidden bg-gray-900 border-b border-gray-800" id="mobileMenu">
                <div class="container mx-auto px-4 py-2 space-y-3">
                    ...
                    <a href="#tuition" class="block text-gray-300 hover:text-[#E2C665] transition py-2">Biaya Kuliah</a>
